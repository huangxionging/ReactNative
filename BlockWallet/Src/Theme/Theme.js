import { scale, scaleVertical } from '../Utility/Scale';
...
const Colors = {
    ...
    overlayBackgound: "#00000057",
    neutralBackgound: "#f2f2f2",
...
export const KittenTheme = {
    ...
    colors: {
        ...
        screen: {
            ...
            overlay: Colors.overlayBackgound
        },
        button: {
            back: Colors.background,
            underlay: Colors.neutralBackgound,
        ...
        chat: {
            messageInBackground: Colors.neutralBackgound,
